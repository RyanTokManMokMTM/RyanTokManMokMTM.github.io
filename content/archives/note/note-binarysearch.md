...
尋找給定數組中的value為4最小index -> and = index : 3
...
例子:
[1,2,3,4,4,4,4,4,5,7] ,n = 10
尋找給定數組中的value為4最小index -> and = index : 7
...
long long minimumTime(vector<int>& time, int totalTrips) {
        ...
        long long low = min, high = min * totalTrips;
        ...
        while(low < high){
            ...
            if(total >= totalTrips) {
                high = mid; //may be the minimum time - lock it
            }else {
