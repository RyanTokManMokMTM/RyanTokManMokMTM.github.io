...
首先,我們需要先知道這2個`Word`有哪些Character的是一致的。為了能獲得他們之間的最長共同子字串，我們可以透過`Longest Common Substring`來得到他們之間共同子字串的長度，只要每個字串的長度減去LCM的長度，就可以知道各自需要多少步。最後相加起來即可。
[Longest Common Substring Template](/leetcodenotes/lcm)
...
public:
    ...
    int longestCommonSubStr(string &s1, string &s2){
        ...
        detail
        define a memo or dp to record each local and
